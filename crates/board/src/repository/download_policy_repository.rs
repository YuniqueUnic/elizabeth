...
pub trait IDownloadPolicyRepository: Send + Sync {
    async fn get_policy_by_content_id(&self, content_id: i64) -> Result<Option<FileDownloadPolicy>, sqlx::Error>;
    async fn upsert_policy(&self, policy: &FileDownloadPolicy) -> Result<FileDownloadPolicy, sqlx::Error>;
